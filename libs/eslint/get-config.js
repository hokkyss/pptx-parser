...
export default function getConfig(opts = {}) {
  ...
  if (typeof opts.environment === "undefined") {
    console.warn('[@monorepo/eslint] opts.environment not found, defaulting to "isomorphic"')
  ...
  if (typeof opts.react === "undefined") {
    console.warn('[@monorepo/eslint] opts.react not found, defaulting to false')
    opts.react = false;
  }
  ...
  if (typeof opts.tanstackRouter === "undefined") {
    console.warn('[@monorepo/eslint] opts.tanstackRouter not found, defaulting to false')
  ...
  if (typeof opts.tanstackQuery === "undefined") {
    console.warn('[@monorepo/eslint] opts.tanstackQuery not found, defaulting to false')
  ...
  if (typeof opts.outDir === "undefined") {
    throw new TypeError("[@monorepo/eslint] opts.outDir must be provided!");
  }
  resolvedOutputDirectory = opts.outDir;

  let resolvedTsconfigRootDir;
  if (typeof opts.tsconfigRootDir === "undefined") {
    throw new TypeError("[@monorepo/eslint] opts.tsconfigRootDir must be provided!");
  }
