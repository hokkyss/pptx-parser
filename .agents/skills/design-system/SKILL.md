...
name: design-system
description: >
  Teaches the agent how to correctly use @monorepo/design-system — the
  project-local shadcn/ui component library. Auto-activates when writing
  code that imports from @monorepo/design-system, when asked to add new
...
Every shadcn component is re-exported as its own named path (e.g. `@monorepo/design-system/button`).
...
import Card from '@monorepo/design-system/card';
import Field from '@monorepo/design-system/field';
import FieldGroup from '@monorepo/design-system/field-group';
import FieldLabel from '@monorepo/design-system/field-label';
import FieldError from '@monorepo/design-system/field-error';
import Input from '@monorepo/design-system/input';
import Select from '@monorepo/design-system/select';
import SelectContent from '@monorepo/design-system/select-content';
import SelectItem from '@monorepo/design-system/select-item';
import SelectTrigger from '@monorepo/design-system/select-trigger';
import SelectValue from '@monorepo/design-system/select-value';

// ❌ Wrong — barrel/index imports do not exist
import { Button, Card } from '@monorepo/design-system';
import Button from '@monorepo/design-system/index';
```
...
@import "@monorepo/design-system/index.css" source(none);
```
...
When a component that does not yet exist in `@monorepo/design-system` needs to be added,
...
```bash
# From the repo root
pnpm --filter @monorepo/design-system shadcn:add <component-name>
# Example:
pnpm --filter @monorepo/design-system shadcn:add combobox
pnpm --filter @monorepo/design-system shadcn:add dialog
```
...
All available `@monorepo/design-system/*` import paths, grouped by category.
