...
- **Reuse Shared Types**: If a schema or DTO is used across multiple domains or packages (e.g., pagination, phone numbers), import it from `@monorepo/common` instead of duplicating it in the local `dto/` folder.
