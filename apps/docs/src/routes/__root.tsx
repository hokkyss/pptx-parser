...
import CardComponent from '@monorepo/design-system/card';
import CardContentComponent from '@monorepo/design-system/card-content';
import CardTitleComponent from '@monorepo/design-system/card-title';
import Toaster from '@monorepo/design-system/toaster';
import tw from '@monorepo/design-system/tw';
      ...
      <CardComponent className={tw`max-w-md w-full`}>
        <CardContentComponent className={tw`flex flex-col gap-y-4 pt-6`}>
          ...
          <p className={tw`text-xs text-muted-foreground font-mono`}>
            Request ID:
            {' '}
            {error instanceof ApplicationError && error.payload['requestId'] as string}
          </p>
          <p className={tw`text-xs text-muted-foreground font-mono`}>
            Build:
            {' '}
