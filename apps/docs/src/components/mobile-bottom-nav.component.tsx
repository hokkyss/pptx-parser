...
export default function MobileBottomNav() {
  ...
  return (
    ...
    >
      <div
        className="relative pointer-events-auto flex items-center justify-around px-2 py-1.5 rounded-full backdrop-blur-3xl backdrop-saturate-150 bg-white/15 dark:bg-black/25 border border-white/50 dark:border-white/10 shadow-[0_12px_40px_-8px_rgba(0,0,0,0.12),inset_0_1px_1px_0_rgba(255,255,255,0.7),inset_0_-1px_1px_0_rgba(0,0,0,0.03)] dark:shadow-[0_12px_40px_-8px_rgba(0,0,0,0.6),inset_0_1px_1px_0_rgba(255,255,255,0.15),inset_0_-1px_1px_0_rgba(0,0,0,0.3)] ring-1 ring-black/5 dark:ring-white/5"
        style={{
      ...
      >
        ...
        <div
          aria-hidden="true"
          className="absolute top-1.5 bottom-1.5 rounded-full bg-black/5 dark:bg-white/10 backdrop-blur-md border border-white/50 dark:border-white/15 shadow-[inset_0_1px_1px_0_rgba(255,255,255,0.3),0_2px_8px_0_rgba(0,0,0,0.03)] pointer-events-none z-0 transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]"
          style={{
            left: '0.5rem',
