...
export function parseSingleShape(
  ...
  if (shapeType === 'picture') {
    ...
    if (audioFileNode) {
      const audioRelId = (audioFileNode['@_r:link'] as string) || (audioFileNode['@_link'] as string) || (audioFileNode['r:link'] as string) || (audioFileNode['link'] as string);
    ...
    if (videoFileNode) {
      const videoRelId = (videoFileNode['@_r:link'] as string) || (videoFileNode['@_link'] as string) || (videoFileNode['r:link'] as string) || (videoFileNode['link'] as string);
